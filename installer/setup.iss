...
[Files]
; Core binaries
Source: "..\release\GameAgentMonitor\bin\monitor_app.exe";  DestDir: "{app}\bin"; Flags: ignoreversion Components: core
Source: "..\release\GameAgentMonitor\bin\logger.dll";       DestDir: "{app}\bin"; Flags: ignoreversion Components: core
Source: "..\release\GameAgentMonitor\bin\updater.exe";      DestDir: "{app}\bin"; Flags: ignoreversion Components: core
Source: "..\release\GameAgentMonitor\bin\updater.new";      DestDir: "{app}\bin"; Flags: ignoreversion Components: core
Source: "..\release\GameAgentMonitor\bin\capture_common.dll"; DestDir: "{app}\bin"; Flags: ignoreversion Components: core capture

; Capture modules
Source: "..\release\GameAgentMonitor\bin\capture_wgc.dll";     DestDir: "{app}\bin"; Flags: ignoreversion Components: capture
Source: "..\release\GameAgentMonitor\bin\capture_gdi.dll";     DestDir: "{app}\bin"; Flags: ignoreversion Components: capture
Source: "..\release\GameAgentMonitor\bin\capture_desktop.dll"; DestDir: "{app}\bin"; Flags: ignoreversion Components: capture
Source: "..\release\GameAgentMonitor\bin\capture_pw.dll";      DestDir: "{app}\bin"; Flags: ignoreversion Components: capture
Source: "..\release\GameAgentMonitor\bin\capture_screen.dll";  DestDir: "{app}\bin"; Flags: ignoreversion Components: capture

; Input modules
Source: "..\release\GameAgentMonitor\bin\input_common.dll";      DestDir: "{app}\bin"; Flags: ignoreversion Components: input
Source: "..\release\GameAgentMonitor\bin\input_sendinput.dll";   DestDir: "{app}\bin"; Flags: ignoreversion Components: input
Source: "..\release\GameAgentMonitor\bin\input_postmessage.dll"; DestDir: "{app}\bin"; Flags: ignoreversion Components: input
Source: "..\release\GameAgentMonitor\bin\input_winapi.dll";      DestDir: "{app}\bin"; Flags: ignoreversion Components: input
Source: "..\release\GameAgentMonitor\bin\input_driver.dll";      DestDir: "{app}\bin"; Flags: ignoreversion Components: input

; Frontend
Source: "..\release\GameAgentMonitor\frontend\*"; DestDir: "{app}\frontend"; Flags: ignoreversion recursesubdirs Components: frontend

; Config template
Source: "..\config\settings.default.json"; DestDir: "{app}\config"; Flags: ignoreversion Components: core

; Version manifest
Source: "..\release\GameAgentMonitor\version.json"; DestDir: "{app}"; Flags: ignoreversion Components: core
